...
class ConfigurationController extends Controller
{
     ...
     * @return void
     */
    public function __construct(Request $request, ConfigurationRepository $repo)
    {
    ...
    public function getConfigurationVariable()
    {
        ...
        return $this->success(compact('color_themes', 'directions', 'date_formats', 'time_formats', 'notification_positions', 'timezones', 'sidebar', 'currencies','days'));
    }
