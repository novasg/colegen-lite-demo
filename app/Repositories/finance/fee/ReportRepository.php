...
class ReportRepository
{
    ...
    public function getFeePaymentData($params)
    {
        ...
        $query = $this->transaction->with([
            ...
            ])->select(['id','prefix','number','student_fee_record_id','payment_method_id','account_id','amount','date','reference_number'])->filterBySession()->whereNotNull('student_fee_record_id')->filterByHead('fee')->dateBetween([
        ...
        foreach ($transactions as $transaction) {
            $list[] = array(
                ...
                'payment_method'        => $transaction->payment_method_id ? $transaction->paymentMethod->name : '-',
