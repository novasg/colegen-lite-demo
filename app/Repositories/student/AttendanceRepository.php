...
class AttendanceRepository
{
    ...
    public function getPreRequisite()
    {
        ...
        return compact('batches', 'holidays','batch_with_subjects');
    }
    ...
    public function fetch($params)
    {
        ...
        $this->validateAttendance($params);
        ...
        $attendance = $this->student_attendance->whereBatchId($batch_id)->whereDateOfAttendance($date)->first();
     ...
     * @return void
     */
    private function validateAttendance($params = array())
    {
        $batch_id = gv($params, 'batch_id');
    ...
    public function default($params = array())
    {
        ...
        $student_attendance = $this->student_attendance->whereBatchId($batch_id)->whereDateOfAttendance($date_of_attendance)->first();
    ...
    public function getAbsenteeFilters()
    {
        ...
        return compact('batches','batch_with_subjects');
    }
    ...
    public function studentMonthlyReport($student_uuid, $student_record_id)
    {
        ...
        $attendances = $this->student_attendance->dateOfAttendanceBetween(['start_date' => config('config.default_academic_session.start_date'), 'end_date' => config('config.default_academic_session.end_date')])->whereBatchId($student_record->batch_id)->get();
