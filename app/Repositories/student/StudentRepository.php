...
class StudentRepository
{
    ...
    {
        $student = $this->student->filterByUuid($id)->first();
    ...
    public function getPreRequisite()
    {
        ...
        return compact('genders', 'student_parents','guardian_relations');
    }
    ...
    public function getData($params)
    {
        ...
        $query = $this->student_record->with('student','admission','batch','batch.course','student.parent')
    ...
    public function getFilters()
    {
        ...
        return compact('batches', 'student_groups','genders');
    }
