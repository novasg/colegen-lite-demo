...
class RegistrationRepository
{
    ...
    public function findOrFail($id, $field = 'message')
    {
        ...
        },'transactions.account','transactions.paymentMethod','transactions.user','transactions.user.employee'])->filterBySession()->filterById($id)->first();
    ...
    public function getData($params)
    {
        ...
        $query = $this->registration->with('student', 'student.parent', 'course', 'course.courseGroup')->filterBySession()->dateOfRegistrationBetween([
    ...
    public function getFilters()
    {
        ...
        $registration_types = [];
        return compact('courses','registration_types');
    }
    ...
    public function getPreRequisite()
    {
        ...
        return compact('courses', 'genders', 'course_details','guardian_relations');
    }
