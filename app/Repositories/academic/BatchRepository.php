...
class BatchRepository
{
    ...
    {
        return $this->batch->with('course')->filterBySession()->filterById($id)->first();
    }
    ...
    {
        $batch = $this->batch->with('course')->filterBySession()->filterById($id)->first();
    ...
    {
        $batch = $this->batch->with('course')->filterBySession($session_id)->filterById($id)->first();
    ...
    public function getData($params)
    {
        ...
        $query = $this->batch->with(['course:id,name'])->withCount(['studentRecords' => function ($q) {
